CREATE OR REPLACE TABLE betting_dv.FOOTBALL_MATCH_HIS_L_S_UNDERSTAT_TEAM_STRENGTH_FEATURES_EMA15_HA
as
SELECT
	--general match_info
	...
	ema.HOME_shots_on_target_FOR_EMA15 / div_stats.HOME_shots_on_target_FOR_SMA500 			home_shots_on_target_for_strength,
	ema.HOME_shots_on_target_AGAINST_EMA15 / div_stats.HOME_shots_on_target_FOR_SMA500		home_shots_on_target_against_strength,
	...
	ema.away_shots_on_target_FOR_EMA15 / div_stats.away_shots_on_target_FOR_SMA500 			away_shots_on_target_for_strength,
	ema.away_shots_on_target_AGAINST_EMA15 / div_stats.away_shots_on_target_FOR_SMA500		away_shots_on_target_against_strength,
...
FROM 
	BETTING_DV.FOOTBALL_MATCH_HIS_L_S_UNDERSTAT_TEAM_STATS_EMA15_ha ema
