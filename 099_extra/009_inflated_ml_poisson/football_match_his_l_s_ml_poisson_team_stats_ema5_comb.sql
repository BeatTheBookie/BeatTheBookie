create or replace table betting_dv.football_match_his_l_s_ml_poisson_team_stats_ema5_comb as
WITH mvd_stats
AS
(
/**
...
(
SELECT
  	betting_dv.ema(mvd_stats.football_team_hid, mvd_stats.match_date, mvd_stats.goals_for, 5)  
from
  	mvd_stats
GROUP BY
...
(
SELECT
  	betting_dv.ema(mvd_stats.football_team_hid, mvd_stats.match_date, mvd_stats.goals_against, 5)  
from
  	mvd_stats
GROUP BY
	mvd_stats.football_team_hid
...
(
SELECT
  	betting_dv.ema(mvd_stats.football_team_hid, mvd_stats.match_date, mvd_stats.xg_for, 5)  
from
  	mvd_stats
GROUP BY
	mvd_stats.football_team_hid
...
(
SELECT
  	betting_dv.ema(mvd_stats.football_team_hid, mvd_stats.match_date, mvd_stats.xg_against, 5)  
from
  	mvd_stats
GROUP BY
	mvd_stats.football_team_hid
...
(
SELECT
  	betting_dv.ema(mvd_stats.football_team_hid, mvd_stats.match_date, mvd_stats.shots_for, 5)  
from
  	mvd_stats
GROUP BY
	mvd_stats.football_team_hid
...
(
SELECT
  	betting_dv.ema(mvd_stats.football_team_hid, mvd_stats.match_date, mvd_stats.shots_against, 5)  
from
  	mvd_stats
GROUP BY
	mvd_stats.football_team_hid
...
(
SELECT
  	betting_dv.ema(mvd_stats.football_team_hid, mvd_stats.match_date, mvd_stats.sot_for, 5)  
from
  	mvd_stats
GROUP BY
	mvd_stats.football_team_hid
...
(
SELECT
  	betting_dv.ema(mvd_stats.football_team_hid, mvd_stats.match_date, mvd_stats.sot_against, 5)  
from
  	mvd_stats
GROUP BY
	mvd_stats.football_team_hid
...
(
SELECT
  	betting_dv.ema(mvd_stats.football_team_hid, mvd_stats.match_date, mvd_stats.corners_for, 5)  
from
  	mvd_stats
GROUP BY
	mvd_stats.football_team_hid
...
(
SELECT
  	betting_dv.ema(mvd_stats.football_team_hid, mvd_stats.match_date, mvd_stats.corners_against, 5)  
from
  	mvd_stats
GROUP BY
	mvd_stats.football_team_hid
...
(
SELECT
  	betting_dv.ema(mvd_stats.football_team_hid, mvd_stats.match_date, mvd_stats.deep_for, 5)  
from
  	mvd_stats
GROUP BY
	mvd_stats.football_team_hid
...
(
SELECT
  	betting_dv.ema(mvd_stats.football_team_hid, mvd_stats.match_date, mvd_stats.deep_against, 5)  
from
  	mvd_stats
GROUP BY
	mvd_stats.football_team_hid
...
(
SELECT
  	betting_dv.ema(mvd_stats.football_team_hid, mvd_stats.match_date, mvd_stats.ppda_for, 5)  
from
  	mvd_stats
GROUP BY
	mvd_stats.football_team_hid
...
(
SELECT
  	betting_dv.ema(mvd_stats.football_team_hid, mvd_stats.match_date, mvd_stats.ppda_against, 5)  
from
  	mvd_stats
GROUP BY
	mvd_stats.football_team_hid
