create or replace table betting_dv.football_match_his_l_s_ml_poisson_team_stats_ema15_comb as
WITH mvd_stats
AS
(
/**
...
(
SELECT
  	betting_dv.ema(mvd_stats.football_team_hid, mvd_stats.match_date, mvd_stats.sot_for, 15)  
from
  	mvd_stats
GROUP BY
	mvd_stats.football_team_hid
...
(
SELECT
  	betting_dv.ema(mvd_stats.football_team_hid, mvd_stats.match_date, mvd_stats.sot_against, 15)  
from
  	mvd_stats
GROUP BY
	mvd_stats.football_team_hid
...
(
SELECT
  	betting_dv.ema(mvd_stats.football_team_hid, mvd_stats.match_date, mvd_stats.corners_for, 15)  
from
  	mvd_stats
GROUP BY
	mvd_stats.football_team_hid
...
(
SELECT
  	betting_dv.ema(mvd_stats.football_team_hid, mvd_stats.match_date, mvd_stats.corners_against, 15)  
from
  	mvd_stats
GROUP BY
	mvd_stats.football_team_hid
