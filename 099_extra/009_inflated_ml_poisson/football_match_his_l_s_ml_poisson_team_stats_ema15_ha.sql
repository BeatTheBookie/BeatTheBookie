create or replace table betting_dv.football_match_his_l_s_ml_poisson_team_stats_ema15_ha AS
with
home_his as
(
/**
...
*****/
home_sot_for_ema15 as
(
select
  betting_dv.ema(home_team, match_date, home_sot_for, 15)  
from
  home_his
group by
  home_team
),
home_sot_against_ema15 as
(
select
  betting_dv.ema(home_team, match_date, home_sot_against, 15)  
from
  home_his
group by
  home_team
...
*****/
away_sot_for_ema15 as
(
select
  betting_dv.ema(away_team, match_date, away_sot_for, 15)  
from
  away_his
group by
  away_team
),
away_sot_against_ema15 as
(
select
  betting_dv.ema(away_team, match_date, away_sot_against, 15)  
from
  away_his
group by
  away_team
...
*****/
home_corners_for_ema15 as
(
select
  betting_dv.ema(home_team, match_date, home_corners_for, 15)  
from
  home_his
group by
  home_team
),
home_corners_against_ema15 as
(
select
  betting_dv.ema(home_team, match_date, home_corners_against, 15)  
from
  home_his
group by
  home_team
...
calculate EMA for away xg
*****/
away_corners_for_ema15 as
(
select
  betting_dv.ema(away_team, match_date, away_corners_for, 15)  
from
  away_his
group by
  away_team
),
away_corners_against_ema15 as
(
select
  betting_dv.ema(away_team, match_date, away_corners_against, 15)  
from
  away_his
group by
  away_team
...
select
  ...
  --home ema stats
  --goals
  home_goals_for_ema15.ema home_goals_for_ema,
  home_goals_against_ema15.ema home_goals_against_ema,
  --xg
  home_xg_for_ema15.ema home_xg_for_ema,
  home_xg_against_ema15.ema home_xg_against_ema,
  --shots
  home_shots_for_ema15.ema home_shots_for_ema,
  home_shots_against_ema15.ema home_shots_against_ema,
  --shots on target
  home_sot_for_ema15.ema home_sot_for_ema,
  home_sot_against_ema15.ema home_sot_against_ema,
  --corners
  home_corners_for_ema15.ema home_corners_for_ema,
  home_corners_against_ema15.ema home_corners_against_ema,
  --deep
  home_deep_for_ema15.ema home_deep_for_ema,
  home_deep_against_ema15.ema home_deep_against_ema,
  --ppda
  home_ppda_for_ema15.ema home_ppda_for_ema,
  home_ppda_against_ema15.ema home_ppda_against_ema,
  --away ema stats
  --goals
  away_goals_for_ema15.ema away_goals_for_ema,
  away_goals_against_ema15.ema away_goals_against_ema,
  --xg
  away_xg_for_ema15.ema away_xg_for_ema,
  away_xg_against_ema15.ema away_xg_against_ema,
  --shots
  away_shots_for_ema15.ema away_shots_for_ema,
  away_shots_against_ema15.ema away_shots_against_ema,
  --shots on target
  away_sot_for_ema15.ema away_sot_for_ema,
  away_sot_against_ema15.ema away_sot_against_ema,
  --corners
  away_corners_for_ema15.ema away_corners_for_ema,
  away_corners_against_ema15.ema away_corners_against_ema,
  --deep
  away_deep_for_ema15.ema away_deep_for_ema,
  away_deep_against_ema15.ema away_deep_against_ema,
  --ppda
  away_ppda_for_ema15.ema away_ppda_for_ema,
  away_ppda_against_ema15.ema away_ppda_against_ema
from
  ...
  join home_sot_for_ema15 on 
    his.home_team = home_sot_for_ema15.group_param and
    his.match_date = home_sot_for_ema15.order_param
  join home_sot_against_ema15 on 
    his.home_team = home_sot_against_ema15.group_param and
    his.match_date = home_sot_against_ema15.order_param
  --join ema calcs for home team corners
  join home_corners_for_ema15 on 
    his.home_team = home_corners_for_ema15.group_param and
    his.match_date = home_corners_for_ema15.order_param
  join home_corners_against_ema15 on 
    his.home_team = home_corners_against_ema15.group_param and
    his.match_date = home_corners_against_ema15.order_param
  ...
  join away_sot_for_ema15 on 
    his.away_team = away_sot_for_ema15.group_param and
    his.match_date = away_sot_for_ema15.order_param
  join away_sot_against_ema15 on 
    his.away_team = away_sot_against_ema15.group_param and
    his.match_date = away_sot_against_ema15.order_param
  --join ema calcs for away team corners
  join away_corners_for_ema15 on 
    his.away_team = away_corners_for_ema15.group_param and
    his.match_date = away_corners_for_ema15.order_param
  join away_corners_against_ema15 on 
    his.away_team = away_corners_against_ema15.group_param and
    his.match_date = away_corners_against_ema15.order_param
