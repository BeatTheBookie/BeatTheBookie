...
--drop view betting_dv.football_match_cur_l_s_attack_defence_strength_30;

create or replace table betting_dv.football_match_cur_l_s_attack_defence_strength_30
AS
select
...
from
	--match combinations
	raw_dv.football_match_cur_l fixtures
		...
		from
			...
			from
				...
				from
					...
					join raw_dv.football_team_division_l team_division
					...
					join raw_dv.football_match_his_l his
