...
drop table if exists meta.transfermarkt_market_value_season_config; 

create table meta.transfermarkt_market_value_season_config
	(
	division	varchar(50),
	url			varchar(200)
	);
