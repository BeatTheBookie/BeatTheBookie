...
--drop table betting_dv.football_match_his_l_s_rating_features_4;

create or replace table betting_dv.football_match_his_l_s_rating_features_4
as
select
